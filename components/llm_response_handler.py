...
class StStreamResHandler:
    def __init__(self, parent_status: StatusContainer, thinking_container: DeltaGenerator):
        self.content_str = ''
        self.thinking_str = ''
    ...
    def content_chunk(self, chunk: str):
        ...
        if self._parent_status._current_state != "running":
            self._parent_status.update(state="running")
    ...
    def content_end(self):
        if self._parent_status._current_state != "complete":
